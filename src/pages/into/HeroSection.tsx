...
const HeroSection = () => {
  ...
  const heroImages = [{
    src: 'projects-page/Interior/hero1.webp',
    title: isRTL ? 'صالة معيشة فاخرة' : 'Luxury Living Room'
  }, {
    src: 'projects-page/Interior/hero2.webp',
    title: isRTL ? 'تصميм معاصر' : 'Contemporary Design'
  }, {
    src: 'projects-page/Interior/hero3.webp',
    title: isRTL ? 'غرفة معيشة أنيقة' : 'Elegant Living Space'
  }, {
    src: 'projects-page/Interior/hero4.webp',
  ...
  return (
    <section className="min-h-[90vh] md:min-h-screen flex items-center relative overflow-hidden font-bold">
      {/* Background Images */}
            ...
            <div className={`flex flex-wrap gap-4 md:gap-6 ${isRTL ? 'justify-end' : 'justify-start'}`}>
              ...
              >
                ...
                <span className="relative z-10 flex items-center">
                  {isRTL ? 'استكشف التصاميم الداخلية' : 'Explore Interior Designs'}
              ...
              <button
                ...
                className="group relative overflow-hidden bg-transparent border-2 border-white/80 text-white px-6 py-3 md:px-8 md:py-4 rounded-lg hover:bg-white hover:text-charcoal transition-all duration-300 inline-block transform hover:scale-105 hover:shadow-2xl backdrop-blur-sm text-sm md:text-base font-bold"
              >
                <div className="absolute inset-0 bg-white transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left"></div>
                <span className="relative z-10 transition-colors duration-300">
                  {isRTL ? 'منتجات الاضاءة الاخري' : 'Other Lighting products'}
                </span>
              </button>
