...
const CTASection = () => {
  ...
  return (
    <section className="relative py-24 md:py-12 lg:py-12 pl-8 pr-6 mb-8 bg-gradient-to-br from-[#c4a86b] via-[#b8962f] to-[#c4a86b] text-white mt-40 w-full rounded-[20px] md:rounded-[30px] shadow-xl mx-4 md:mx-0">
      {/* Background Elements - Subtle */}
      <div className="absolute inset-0 bg-gradient-to-t from-black/10 via-transparent to-transparent rounded-[20px] md:rounded-[30px]"></div>
        ...
        <div className={`grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center`}>
          ...
          <div className={`${isRTL ? "text-right lg:order-1" : "text-left lg:order-1"} ${isRTL ? "lg:ml-auto" : "lg:mr-auto"} text-center md:text-left`}>
            ...
            <div className="relative inline-block group">
              <Button className="bg-white text-[#c4a86b] hover:bg-white/90 px-6 md:px-8 py-3 md:py-4 text-base md:text-lg font-semibold rounded-full transition-all duration-300 hover:scale-105 shadow-lg w-full md:w-auto">
      ...
      <div className="absolute bottom-0 left-0 right-0 h-2 bg-gradient-to-t from-black/5 to-transparent rounded-b-[20px] md:rounded-b-[30px]"></div>
    </section>
  );
};
